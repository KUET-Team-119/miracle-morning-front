  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.mission}>
        <p className={styles.mission_title}>MISSION</p>
        <p className={styles.mission_korean}>나를 키우는 공간</p>
        <p className={styles.mission_english}>
          A space where you grow yourself
        </p>
      </section>

      <section className={styles.identity}>
        <p className={styles.identity_subtitle}>IDENTITY</p>
        <p className={styles.identity_title}>
          여러분은 어떤 사람이 되고 싶나요?
        </p>
        <p className={styles.identity_explain}>
      ...
      <section>
        ...
        <div className={styles.checkRoutine}>
          <div className={styles.checkRoutineExplain}>
            <p className={styles.checkRoutineExplainSubtitle}>FUNCTION 1.</p>
            <p className={styles.checkRoutineExplainTitle}>루틴 확인 및 인증</p>
